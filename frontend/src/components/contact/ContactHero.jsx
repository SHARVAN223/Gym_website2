...
const ContactHero = () => {
    ...
    return (
        <section
            className="contact-hero about-hero position-relative min-vh-100 d-flex align-items-center text-white overflow-hidden"
            style={{
                backgroundColor: "#080808",
            }}
        >
            <div
                className="contact-hero-image about-hero-image"
                style={{ backgroundImage: `url("${images[currentImage]}")` }}
            ></div>

            <div className="contact-hero-overlay about-hero-overlay"></div>
            ...
            <div className="position-absolute bottom-0 inset-s-50 translate-middle-x mb-4 d-flex gap-2">
                {images.map((_, index) => (
                    <button
                        ...
                        aria-label={`Show Contact hero image ${index + 1}`}
