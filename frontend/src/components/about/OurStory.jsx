...
const OurStory = () => {
    return (
        <section className="our-story-section bg-black text-white py-5 overflow-hidden">
                ...
                <div className="row align-items-center g-5">
                    ...
                    <div className="col-lg-6">
                        <div className="our-story-content">
                            ...
                            <p className="text-danger fw-bold text-uppercase mb-2 our-story-label">
                                Our Story
                            </p>

                            <h2 className="display-5 fw-bold mb-4 our-story-title">
                                BUILT FOR PEOPLE WHO
                                <span className="text-danger"> WANT MORE</span>
                            </h2>

                            <p className="text-secondary fs-5 our-story-text">
                                Aarav Gym was created with one simple goal: to provide
                            ...
                            <div className="row g-3 mt-4">
                                ...
                                <div className="col-sm-6">
                                    <div className="our-story-feature d-flex align-items-center">
                    ...
                    <div className="col-lg-6">
                        <div className="our-story-image-wrapper">
                            ...
                            <img
                                ...
                                alt="PowerFit Gym"
                                className="img-fluid w-100 rounded-4 shadow our-story-image"
                            />
